...
public class HexPosition : System.IEquatable<HexPosition> {
	...
	private static Dictionary<HexaUnit, object> dictionary = new Dictionary<HexaUnit, object> ();
	...
	public void add (string key, object value) {
		HexaUnit hexKey = new HexaUnit (this, key);
	...
	public bool tryGetValue (string key, out object value) {
		return dictionary.TryGetValue (new HexaUnit (this, key), out value);
	}
	...
	public object getValue (string key) {
		...
		if (dictionary.TryGetValue (new HexaUnit (this, key), out value)) {
			return value;
		} else {
			return null;
		}
	...
	public static void clear (string key) {
		foreach (KeyValuePair<HexaUnit, object> kvp in dictionary) {
			if (kvp.Key.Name == key) {
	...
	public bool remove (string key) {
		return dictionary.Remove (new HexaUnit (this, key));
	}
	...
	public bool containsKey (string key) {
		return dictionary.ContainsKey (new HexaUnit (this, key));
	}
